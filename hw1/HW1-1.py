...
# cv2.imwrite(os.path.join(currentDir,'HW1_111062613','1','output', 'normal','a_GaussianBlur_Chess_size5.jpg'), chess_gaussian_blur_5)
# cv2.imwrite(os.path.join(currentDir,'HW1_111062613','1','output', 'normal','a_GaussianBlur_Chess_size10.jpg'), chess_gaussian_blur_10)
# cv2.imwrite(os.path.join(currentDir,'HW1_111062613','1','output', 'normal','a_GaussianBlur_Notredame_size5.jpg'), Notre_gaussian_blur_5)
# cv2.imwrite(os.path.join(currentDir,'HW1_111062613','1','output', 'normal','a_GaussianBlur_Notredame_size10.jpg'), Notre_gaussian_blur_10)
...
# cv2.imwrite(os.path.join(currentDir,'HW1_111062613','1','output','normal','b_Sobel_Chess_directionHSV_Gauss5.jpg'), chess_angle_hsv_Gauss5)
# cv2.imwrite(os.path.join(currentDir,'HW1_111062613','1','output','normal','b_Sobel_Chess_directionHSV_Gauss10.jpg'), chess_angle_hsv_Gauss10)
# cv2.imwrite(os.path.join(currentDir,'HW1_111062613','1','output','normal','b_Sobel_Notre_directionHSV_Gauss5.jpg'), Notre_angle_hsv_Gauss5)
# cv2.imwrite(os.path.join(currentDir,'HW1_111062613','1','output','normal','b_Sobel_Notre_directionHSV_Gauss10.jpg'), Notre_angle_hsv_Gauss10)
...
# cv2.imwrite(os.path.join(currentDir,'HW1_111062613','1','output','normal','b_Sobel_Chess_magnitude_Gauss5.jpg'), chess_sobel_magnitude_Gauss5)
# cv2.imwrite(os.path.join(currentDir,'HW1_111062613','1','output','normal','b_Sobel_Chess_magnitude_Gauss10.jpg'), chess_sobel_magnitude_Gauss10)
# cv2.imwrite(os.path.join(currentDir,'HW1_111062613','1','output','normal','b_Sobel_Notredame_magnitude_Gauss5.jpg'), Notre_sobel_magnitude_Gauss5)
# cv2.imwrite(os.path.join(currentDir,'HW1_111062613','1','output','normal','b_Sobel_Notredame_magnitude_Gauss10.jpg'), Notre_sobel_magnitude_Gauss10)
...
# cv2.imwrite(os.path.join(currentDir,'HW1_111062613','1','output', 'normal','c_Chess_SmallEigenvalue_window3x3_Gauss10.jpg'), small_eigenvalue_chess_window_3x3)
# cv2.imwrite(os.path.join(currentDir,'HW1_111062613','1','output', 'normal','c_Chess_SmallEigenvalue_window5x5_Gauss10.jpg'), small_eigenvalue_chess_window_5x5)
# cv2.imwrite(os.path.join(currentDir,'HW1_111062613','1','output', 'normal','c_Notredame_SmallEigenvalue_window3x3_Gauss10.jpg'), small_eigenvalue_Notre_window_3x3)
# cv2.imwrite(os.path.join(currentDir,'HW1_111062613','1','output', 'normal','c_Notredame_SmallEigenvalue_window5x5_Gauss10.jpg'), small_eigenvalue_Notre_window_5x5)
...
#cv2.imwrite(os.path.join(currentDir,'HW1_111062613','1','output', 'normal','d_chess10_NMS3_H3x3.jpg'), chess10_nms3_h3x3_final)
...
#cv2.imwrite(os.path.join(currentDir,'HW1_111062613','1','output', 'normal','d_chess10_NMS5_H3x3.jpg'), chess10_nms5_h3x3_final)
...
#cv2.imwrite(os.path.join(currentDir,'HW1_111062613','1','output', 'normal','d_chess10_NMS3_H5x5.jpg'), chess10_nms3_h5x5_final)
...
#cv2.imwrite(os.path.join(currentDir,'HW1_111062613','1','output', 'normal','d_chess10_NMS5_H5x5.jpg'), chess10_nms5_h5x5_final)
...
#cv2.imwrite(os.path.join(currentDir,'HW1_111062613','1','output', 'normal','d_Notre10_NMS3_H3x3.jpg'), notre10_nms3_h3x3_final)
...
#cv2.imwrite(os.path.join(currentDir,'HW1_111062613','1','output', 'normal','d_Notre10_NMS5_H3x3.jpg'), notre10_nms5_h3x3_final)
...
#cv2.imwrite(os.path.join(currentDir,'HW1_111062613','1','output', 'normal','d_Notre10_NMS3_H5x5.jpg'), notre10_nms3_h5x5_final)
...
#cv2.imwrite(os.path.join(currentDir,'HW1_111062613','1','output', 'normal','d_Notre10_NMS5_H5x5.jpg'), notre10_nms5_h5x5_final)
...
# cv2.imwrite(os.path.join(currentDir,'HW1_111062613','1','output', 'transformed','a_GaussianBlur_Chess_size5.jpg'), t_chess_gaussian_blur_5)
# cv2.imwrite(os.path.join(currentDir,'HW1_111062613','1','output', 'transformed','a_GaussianBlur_Chess_size10.jpg'), t_chess_gaussian_blur_10)
# cv2.imwrite(os.path.join(currentDir,'HW1_111062613','1','output', 'transformed','a_GaussianBlur_Notredame_size5.jpg'), t_Notre_gaussian_blur_5)
# cv2.imwrite(os.path.join(currentDir,'HW1_111062613','1','output', 'transformed','a_GaussianBlur_Notredame_size10.jpg'), t_Notre_gaussian_blur_10)
...
# cv2.imwrite(os.path.join(currentDir,'HW1_111062613','1','output','transformed','b_Sobel_Chess_directionHSV_Gauss5.jpg'), t_chess_angle_hsv_Gauss5)
# cv2.imwrite(os.path.join(currentDir,'HW1_111062613','1','output','transformed','b_Sobel_Chess_directionHSV_Gauss10.jpg'), t_chess_angle_hsv_Gauss10)
# cv2.imwrite(os.path.join(currentDir,'HW1_111062613','1','output','transformed','b_Sobel_Notre_directionHSV_Gauss5.jpg'), t_Notre_angle_hsv_Gauss5)
# cv2.imwrite(os.path.join(currentDir,'HW1_111062613','1','output','transformed','b_Sobel_Notre_directionHSV_Gauss10.jpg'), t_Notre_angle_hsv_Gauss10)
...
# cv2.imwrite(os.path.join(currentDir,'HW1_111062613','1','output','transformed','b_Sobel_Chess_magnitude_Gauss5.jpg'), t_chess_sobel_magnitude_Gauss5)
# cv2.imwrite(os.path.join(currentDir,'HW1_111062613','1','output','transformed','b_Sobel_Chess_magnitude_Gauss10.jpg'), t_chess_sobel_magnitude_Gauss10)
# cv2.imwrite(os.path.join(currentDir,'HW1_111062613','1','output','transformed','b_Sobel_Notredame_magnitude_Gauss5.jpg'), t_Notre_sobel_magnitude_Gauss5)
# cv2.imwrite(os.path.join(currentDir,'HW1_111062613','1','output','transformed','b_Sobel_Notredame_magnitude_Gauss10.jpg'), t_Notre_sobel_magnitude_Gauss10)
...
# cv2.imwrite(os.path.join(currentDir,'HW1_111062613','1','output', 'transformed','c_Chess_SmallEigenvalue_window3x3_Gauss10.jpg'), t_small_eigenvalue_chess_window_3x3)
# cv2.imwrite(os.path.join(currentDir,'HW1_111062613','1','output', 'transformed','c_Chess_SmallEigenvalue_window5x5_Gauss10.jpg'), t_small_eigenvalue_chess_window_5x5)
# cv2.imwrite(os.path.join(currentDir,'HW1_111062613','1','output', 'transformed','c_Notredame_SmallEigenvalue_window3x3_Gauss10.jpg'), t_small_eigenvalue_Notre_window_3x3)
# cv2.imwrite(os.path.join(currentDir,'HW1_111062613','1','output', 'transformed','c_Notredame_SmallEigenvalue_window5x5_Gauss10.jpg'), t_small_eigenvalue_Notre_window_5x5)
...
# cv2.imwrite(os.path.join(currentDir,'HW1_111062613','1','output', 'transformed','d_chess10_NMS3_H3x3.jpg'), t_chess10_nms3_h3x3_final)
...
# cv2.imwrite(os.path.join(currentDir,'HW1_111062613','1','output', 'transformed','d_chess10_NMS5_H3x3.jpg'), t_chess10_nms5_h3x3_final)
...
# cv2.imwrite(os.path.join(currentDir,'HW1_111062613','1','output', 'transformed','d_chess10_NMS3_H5x5.jpg'), t_chess10_nms3_h5x5_final)
...
# cv2.imwrite(os.path.join(currentDir,'HW1_111062613','1','output', 'transformed','d_chess10_NMS5_H5x5.jpg'), t_chess10_nms5_h5x5_final)
...
# cv2.imwrite(os.path.join(currentDir,'HW1_111062613','1','output', 'transformed','d_Notre10_NMS3_H3x3.jpg'), t_notre10_nms3_h3x3_final)
...
# cv2.imwrite(os.path.join(currentDir,'HW1_111062613','1','output', 'transformed','d_Notre10_NMS5_H3x3.jpg'), t_notre10_nms5_h3x3_final)
...
# cv2.imwrite(os.path.join(currentDir,'HW1_111062613','1','output', 'transformed','d_Notre10_NMS3_H5x5.jpg'), t_notre10_nms3_h5x5_final)
...
# cv2.imwrite(os.path.join(currentDir,'HW1_111062613','1','output', 'transformed','d_Notre10_NMS5_H5x5.jpg'), t_notre10_nms5_h5x5_final)
